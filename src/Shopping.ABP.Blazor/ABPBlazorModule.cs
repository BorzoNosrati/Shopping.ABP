...
using Shopping.ABP.Blazor.Menus;
...
public class ABPBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Shopping.ABP.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<ABPDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Shopping.ABP.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<ABPDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Shopping.ABP.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<ABPApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Shopping.ABP.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<ABPApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Shopping.ABP.Application"));
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<ABPBlazorModule>();
        });
    }
